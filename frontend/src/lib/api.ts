...
// Normalise: add https:// if protocol is missing, strip trailing slash so paths
// like "/api/..." don't produce double-slash URLs (e.g. "host//api/...").
const BASE = (_raw.startsWith("http") ? _raw : `https://${_raw}`).replace(/\/$/, "");
